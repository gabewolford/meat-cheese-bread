...
export default function PhotoRightCTA({
  heading,
  linkTo,
  buttonText,
  hoverColor,
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-6">
      ...
      <div className="col-span-1 md:col-span-2 flex justify-center items-center md:border-l-2 border-t-2 border-black p-4 md:p-6">
